...
<nav class="navbar">
  ...
  <body>
    ...
    <h3 style="margin: 0; color: #fff;">Add Exam</h3>
    <p style="font-size: 14px; color: #fff;">Adding an exam involves inputting details such as question number, question details, mark, and CO number for each exam question into a system, allowing for analysis of course outcomes and program learning outcomes.</p>
    <a class="login-btn" href="addExam.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>
  <div style="width: 300px; height: 300px; background: linear-gradient(to bottom, #4a4a4a, #292929); margin: 10px; padding: 20px; box-sizing: border-box; border-radius: 5px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
    <h3 style="margin: 0; color: #fff;">View Exam</h3>
    <p style="font-size: 14px; color: #fff;"></p>
    <a class="login-btn" href="viewExam.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>

  <div style="width: 300px; height: 300px; background: linear-gradient(to bottom, #4a4a4a, #292929); margin: 10px; padding: 20px; box-sizing: border-box; border-radius: 5px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
    <h3 style="margin: 0; color: #fff;">Evaluate Exam Script</h3>
    <p style="font-size: 14px; color: #fff;"></p>
    <a class="login-btn" href="viewStudentAnswerScript.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>

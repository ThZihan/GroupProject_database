...
<div style="margin-bottom:100px;">
      ...
      <div style="height:80px;background-color: #2b2d42;"class="row1">
        <form method="POST">
        <input style="background-color:#ccc;height:50px;border: 1px solid;cursor: pointer;border-radius: 5px;font-size: 14px;letter-spacing:2px;
                      font-weight: bold;text-transform:uppercase; border: none;outline: none;text-align: center;margin-right:20px;
                      color:black;margin-left:43%;margin-top:13px;" type="text" placeholder="Enter Student ID" name="studentID"/>
             
        <input style="background:#6698FF;border-radius:10px; border:none;outline:none;color:#fff;font-size:14px;
      ...
      <div style="display:flex;justify-content:space-around; background-color: #2b2d42; margin:0;" class="row2">
        <button onclick="overallPlo()" style="width:300px;margin-left:0px;background-color:#333;color:#fff;" class="School-wise" class="School-wise">Overall PLO</button>
        <button onclick="coWisePlo()" style="width:300px;background-color:#333;color:#fff;" class="Department-wise">CO Wise PLO</button>
        <button onclick="courseWisePlo()" style="width:300px;background-color:#333;color:#fff;" class="Program-wise">Course Wise PLO</button>
      </div>

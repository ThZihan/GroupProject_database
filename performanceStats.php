...
<nav class="navbar">
  ...
  <body>
    ...
    <h3 style="margin: 0; color: #fff;">School/<br>Department/<br>Program-wise</h3>
    <p style="font-size: 14px; color: #fff;"></p>
    <a class="login-btn" href="school_department_program_stats.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>
  <div style="width: 300px; height: 300px; background: linear-gradient(to bottom, #4a4a4a, #292929); margin: 10px; padding: 20px; box-sizing: border-box; border-radius: 5px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
    <h3 style="margin: 0; color: #fff;">Course-wise</h3>
    <p style="font-size: 14px; color: #fff;"></p>
    <a class="login-btn" href="courseWisePerformance.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>

  <div style="width: 300px; height: 300px; background: linear-gradient(to bottom, #4a4a4a, #292929); margin: 10px; padding: 20px; box-sizing: border-box; border-radius: 5px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
    <h3 style="margin: 0; color: #fff;">Instructor-wise</h3>
    <p style="font-size: 14px; color: #fff;"></p>
    <a class="login-btn" href="instructorWisePerformance.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>
  

  <div style="width: 300px; height: 300px; background: linear-gradient(to bottom, #4a4a4a, #292929); margin: 10px; padding: 20px; box-sizing: border-box; border-radius: 5px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
    <h3 style="margin: 0; color: #fff;">Instructor-wise <br>(Chosen Course)</h3>
    <p style="font-size: 14px; color: #fff;"></p>
    <a class="login-btn" href="instructorWiseChosenCourse.php" target="_self" style="text-decoration: none; color: #0080ff; font-size: 14px;">Select</a>
</div>



  <div style="width: 300px; height: 300px; background: linear-gradient(to bottom, #4a4a4a, #292929); margin: 10px; padding: 20px; box-sizing: border-box; border-radius: 5px; display: flex; flex-direction: column; justify-content: space-between; box-shadow: 0 5px 10px rgba(0, 0, 0, 0.2);">
    <h3 style="margin: 0; color: #fff;">VC/<br>Dean/<br>Head-wise</h3>
    <p style="font-size: 14px; color: #fff;"></p>

...
<!-- div row-1 starts here -->
     <div style="width: 100%; height: 70px;display:flex;justify-content:center;padding-top:15px;">
     <form method="POST">

     <input style="margin-bottom:0px;background:#ccc;color:black;" class="studentID" type="text" placeholder="Enter Student ID" name="studentID"/>
